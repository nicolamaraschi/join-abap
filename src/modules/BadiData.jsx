...
export const badiData = {
    "FI": [
        {
            name: "BADI_FIN_ACDOC_EXT_VALIDATION",
        ...
        {
            name: "BADI_FIN_ACDOC_EXT_SUBSTITUTION",
        ...
        {
            name: "BADI_FGL_POSTING_VALIDATE",
        ...
        {
            name: "BADI_FGL_POSTING_SUBSTITUTE",
        ...
        {
            name: "FI_HEADER_SUB_1300",
            description: "Un BAdI classico per aggiungere un subscreen personalizzato all'intestazione delle transazioni di registrazione FI (es. FB01).",
            module: "FI",
            transactions: ["FB01"],
            methods: [
                {
        ...
        {
            name: "FCC_NOTIFICATION_CUSTOMIZE",
        ...
        {
            name: "FCC_REFERENCE_DATE_CUSTOM",
    ...
    "CO": [
        ...
        {
            name: "WORKORDER_CONFIRM_CUST_SUBSCR",
        ...
        {
            name: "COPA_MARKET_SEGMENT_MAINT",
    ...
    "SD": [
        ...
        {
            name: "BADI_SD_APM_SET_APPROVAL_REASON",
        ...
        },
        {
            ...
            module: "SD",
            transactions: ["VF01", "Create Billing Documents"],
            methods: [
                {
        ...
        {
            name: "BADI_SD_OUTPUT_EMAIL_SETTINGS",
    ...
    "MM": [
        ...
        {
            name: "MM_PUR_S4_PR_FLDCNTRL_SIMPLE",
    ...
    "PP": [ // Nuova sezione per le BADI di Production Planning (PP)
        {
        ...
        },
        {
            ...
            methods: [
                {
                    name: "AT_SAVE",
                    parameters: "IS_CONFIRMATION TYPE CAUFVD", // Esempio: i parametri specifici possono variare
        ...
        },
        {
            ...
            module: "PP",
            transactions: ["MD01N (MRP Live)", "MD04 (Stock/Requirements List)", "MRP classico", "App Fiori MRP"],
            methods: [
                {
