...
const highlightAbapSyntax = (code) => {
  ...
  const highlightKeywordsAndStrings = (part) => {
    const keywords = [
      ...
      'COMPONENT', 'COMPONENTS', 'COMPUTE', 'CONCATENATE', 'CONDENSE', 'CONNECT', 'CONSIDERING', 'CONTEXT',
      'CONTROLS', 'CONVERT', 'COPY', 'CORRESPONDING', 'COUNT', 'COUNTRY', 'CROSS', 'CURRENCY', 'CURSOR',
      'DATASET', 'DAYLIGHT', 'DECIMALS', 'DECODE', 'DEFERRED', 'DEMAND', 'DEPENDING', 'DESCENDING',
      'DESTINATION', 'DETAIL', 'DIALOG', 'DISTINCT', 'DIVIDE', 'DUPLICATES', 'DYNAMIC', 'EDIT', 'EDITOR-CALL',
      ...
      'EXECUTE', 'EXCEPT', 'EXPAND', 'EXPERIMENTAL', 'EXTENDED', 'EXTENSION', 'EXTRACT', 'FETCH', 'FIELDS',
      'FILE', 'FILTER', 'FINAL', 'FIRST', 'FIXED-POINT', 'FLUSH', 'FOR', 'FRACTIONAL', 'FULL', 'FUNCTION-POOL',
      ...
      'IN', 'INCREMENT', 'INDEX', 'INNER', 'INFOTYPES', 'INHERITING', 'INITIAL', 'INNER', 'INPUT', 'INSTANCE',
      'INSTANCES', 'INTERFACE', 'INTERFACES', 'INTERSECT', 'INTERVALS', 'INVERTED-DATE', 'IS', 'ISOLATION',
      'JOIN', 'LANGUAGE', 'LAST', 'LATE', 'LEADING', 'LEFT', 'LEFT-JUSTIFIED', 'LENGTH', 'LEVEL', 'LINES',
      ...
      'OPTIONS', 'OR', 'ORDER', 'OTHERS', 'OUTER', 'OUTPUT', 'OVERLAY', 'PACKAGE', 'PAGE',
      ...
      'RESET', 'RESPECTING', 'RESUMABLE', 'RIGHT', 'RIGHTJUSTIFIED', 'RISK', 'ROUND', 'ROWS', 'RUN',
      ...
      'TRUNCATE', 'TRUNCATION', 'TRYING', 'UNION', 'UNIQUE', 'UNIT', 'UNIX', 'UNWIND', 'UP', 'UPPER',
